  ...
  en: {
    translation: {
      ...
      errors: {
        ...
        jammerUnavailable: "Jammer analysis is unavailable.",
      ...
      jammer: {
        title: "Jammer analysis",
        helper:
          "Use Baseline as clean air and Compare with as the jammer-on measurement. This analyzes PSD rise against the clean baseline, not against the current median.",
        threshold: "Rise threshold, dB",
        button: "Analyze jammer",
        loading: "Analyzing jammer...",
        raisedRange: "Raised range",
        raisedBandwidth: "Raised bandwidth",
        raisedBins: "Raised bins",
        noiseFloorDelta: "PSD floor delta",
        meanDelta: "Mean PSD delta",
        medianDelta: "Median PSD delta",
        p90Delta: "P90 PSD delta",
        maxDelta: "Max PSD delta",
        integratedPowerDelta: "Integrated power delta",
        peakDeltaFrequency: "Peak delta frequency",
        frequency: "Frequency",
        baselinePsd: "Baseline PSD",
        jammerPsd: "Jammer PSD",
        delta: "Delta",
      },
      range: {
  ...
  uk: {
    translation: {
      ...
      errors: {
        ...
        jammerUnavailable: "Аналіз джамера недоступний.",
      ...
      jammer: {
        title: "Аналіз джамера",
        helper:
          "Використовуйте Базу як чистий ефір, а Порівняти з як вимір із джамером. Тут рахується підняття PSD відносно чистого baseline, а не відносно медіани поточного виміру.",
        threshold: "Поріг підняття, dB",
        button: "Проаналізувати джамер",
        loading: "Аналізую джамер...",
        raisedRange: "Піднятий діапазон",
        raisedBandwidth: "Піднята смуга",
        raisedBins: "Підняті клітинки",
        noiseFloorDelta: "Delta PSD шуму",
        meanDelta: "Середня PSD delta",
        medianDelta: "Медіанна PSD delta",
        p90Delta: "P90 PSD delta",
        maxDelta: "Макс. PSD delta",
        integratedPowerDelta: "Delta інтегральної потужності",
        peakDeltaFrequency: "Частота пікової delta",
        frequency: "Частота",
        baselinePsd: "Baseline PSD",
        jammerPsd: "Jammer PSD",
        delta: "Delta",
